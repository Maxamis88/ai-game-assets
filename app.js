  ...
  generateBtn.addEventListener('click', async () => {
    ...
    try {
      ...
      img.onload = () => {
        ...
        const previewW = size * scale;
        const previewH = size * scale;
        ...
        const jsonData = {
          ...
          frames: [{ filename: `${size}x${size}-sprite.png`, frame: {x:0,y:0,w:size,h:size}, sourceSize: {w:size,h:size} }]
        };
        ...
        status.textContent = `✅ ${size}x${size} sprite ready! Drag to GDevelop.`;
